...
public class AudioRecordView {
    ...
    private View layoutAttachment, layoutDustin, layoutMessage, imageViewAttachment;
    //            , imageViewCamera, imageViewEmoji;
    ...
    private boolean showCameraIcon = false, showAttachmentIcon = true, showEmojiIcon = false;
        ...
        imageViewAudio.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (isLayoutDirectionRightToLeft ? (motionX > directionOffset && lastX > firstX &&
                            lastY > firstY) : (motionX > directionOffset && lastX < firstX && lastY < firstY)) {
