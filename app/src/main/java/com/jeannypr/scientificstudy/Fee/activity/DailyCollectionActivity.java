...
import com.jeannypr.scientificstudy.Fee.fragment.StudentWiseCollectonFragment;
...
public class DailyCollectionActivity extends AppCompatActivity {
    ...
    private void SetUpViewPager() {
        DailyCollectionActivity.HeadVPagerAdapter adapter = new DailyCollectionActivity.HeadVPagerAdapter(getSupportFragmentManager());

        HeadWiseCollectionFragment headWiseCollectionFragment = new HeadWiseCollectionFragment();
        StudentWiseCollectonFragment studentWiseCollectonFragment = new StudentWiseCollectonFragment();
      //  ModeWiseCollectionFragment modeWiseCollectionFragment = new ModeWiseCollectionFragment();

        adapter.addFragment(headWiseCollectionFragment, "Head Wise");
       // adapter.addFragment(modeWiseCollectionFragment, "Mode Wise");
        adapter.addFragment(studentWiseCollectonFragment, "Student Wise");
