...
public class DateWiseCollectonFragment extends Fragment implements View.OnClickListener {
    ...
    public DateWiseCollectonFragment() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        listContainer = view.findViewById(R.id.reyclerview_datewise_collection_list);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.toDate:
                ...
                final DatePickerDialog toDateDialog = new DatePickerDialog(context, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
