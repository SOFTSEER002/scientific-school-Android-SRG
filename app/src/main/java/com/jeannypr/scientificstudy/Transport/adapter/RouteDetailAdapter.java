...
public class RouteDetailAdapter extends RecyclerView.Adapter {
    ...
    public RouteDetailAdapter(Context context, List<RouteDetailModel> routes) {
        super();
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new RouteDetailAdapter.MyViewHolder(view);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        TextView studentName, className, stoppageName, admNo, vehicleNo, mobile;
