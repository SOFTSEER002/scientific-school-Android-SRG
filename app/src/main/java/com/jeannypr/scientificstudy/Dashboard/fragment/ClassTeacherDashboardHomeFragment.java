...
public class ClassTeacherDashboardHomeFragment extends Fragment implements DashboardHomeTabNavigator, View.OnClickListener {
   ...
   /* public ClassTeacherDashboardHomeFragment(MainNavigator navigator) {
        mNavigator = navigator;
    }*/

    public ClassTeacherDashboardHomeFragment() {
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewBinding.notifyIc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mNavigator.redirectToNotification();
            }
        });
        mViewBinding.busIc.setVisibility(View.INVISIBLE);
