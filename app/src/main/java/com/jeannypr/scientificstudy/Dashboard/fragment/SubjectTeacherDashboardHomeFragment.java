...
public class SubjectTeacherDashboardHomeFragment extends Fragment implements DashboardHomeTabNavigator, View.OnClickListener {
    ...
    /*public SubjectTeacherDashboardHomeFragment(MainNavigator navigator) {
    ...
    public SubjectTeacherDashboardHomeFragment() {
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //mViewBinding.busIc.setVisibility(View.GONE);
